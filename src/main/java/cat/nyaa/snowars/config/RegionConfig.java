...
public class RegionConfig implements ISerializable {
    ...
    public RegionConfig(String name, Region region) {
        this.name = name;
        this.region = region;
        autoSpawns = new ArrayList<>();
    }

    public RegionConfig(){}

    public void addAutoSpawn(String name) {
        autoSpawns.add(name);
    }

    public boolean containsAutoSpawn(String producerName) {
        return autoSpawns.contains(producerName);
    }

    public void removeAutoSpawn(String producerName) {
        autoSpawns.remove(producerName);
    }

    public Collection<? extends String> getAutoSpawns() {
        return autoSpawns;
    }
